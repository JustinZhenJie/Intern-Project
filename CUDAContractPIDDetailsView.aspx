<%@ Page Title="" Language="C#" MasterPageFile="~/CUDAMasterPage.Master" AutoEventWireup="true" CodeBehind="CUDAContractPIDDetailsView.aspx.cs" Inherits="JKTS_Contract_system.CUDAContractPIDDetailsView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="contractID" OnDataBound="DetailsView1_DataBound" CssClass="DetailsView">
        <Fields>
            ...
            <asp:BoundField DataField="contractDuration" HeaderText="Duration of Contract (in month)">
                <HeaderStyle Font-Bold="true" />
            </asp:BoundField>
