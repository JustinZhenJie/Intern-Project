<%@ Page Title="" Language="C#" MasterPageFile="~/CUDAMasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="CUDACreateContract.aspx.cs" Inherits="JKTS_Contract_system.CUDACreateContract" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lbl_ContractParentID" runat="server" Text="Label" Visible="false"></asp:Label>
    ...
    <table class="auto-style3">
        ...
        <tr>
            <td></td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" Enabled="false" runat="server" ControlToValidate="counterpartyTb" ErrorMessage="Please enter name of counterparty" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <td>
                <td>
                    <asp:CompareValidator ID="dateValidator" runat="server"
                        Type="Date" Operator="DataTypeCheck" ControlToValidate="contractDateTB"
                        ErrorMessage="Please enter a valid date." Font-Bold="True" ForeColor="Red">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server"
                    Type="Date" Operator="DataTypeCheck" ControlToValidate="startDateTb"
                    ErrorMessage="Please enter a valid date." Font-Bold="True" ForeColor="Red">
                </asp:CompareValidator>
        ...
        <tr>
            <td></td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="endDateTb" ErrorMessage="Please enter contract end date" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:CompareValidator ID="CompareValidator2" runat="server"
                    Type="Date" Operator="DataTypeCheck" ControlToValidate="endDateTb"
                    ErrorMessage="Please enter a valid date." Font-Bold="True" ForeColor="Red">
                </asp:CompareValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:DropDownList ID="automaticExtensionList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="automaticExtensionList_SelectedIndexChanged1">
                    <asp:ListItem>---Select---</asp:ListItem>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:DropDownList ID="decisionMakerList" runat="server" DataSourceID="SqlDataSource1" DataTextField="ContractDecisionMakerName" DataValueField="ContractDecisionMakerName" OnSelectedIndexChanged="decisionMakerList_SelectedIndexChanged1">
                    <asp:ListItem>---Select---</asp:ListItem>
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:DropDownList ID="reviewedByLADeptList" AutoPostBack="true" runat="server" OnSelectedIndexChanged="reviewedByLADeptList_SelectedIndexChanged1">
                    <asp:ListItem>---Select---</asp:ListItem>
                    <asp:ListItem>Yes</asp:ListItem>
                    <asp:ListItem>No</asp:ListItem>
                </asp:DropDownList>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnBack" runat="server" Text="Back" OnClick="btnBack_OnClick" CausesValidation="False" />
    &nbsp;&nbsp;&nbsp;
