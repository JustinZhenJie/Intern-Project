...
{
    public partial class CUContractDetails : System.Web.UI.Page
    {
        ...
        protected void contractGridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CUContractPIDDetailsView.aspx");
        }

        protected void contractListingBtn_Click(object sender, EventArgs e)
        {
