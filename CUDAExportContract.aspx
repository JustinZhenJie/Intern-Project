<%@ Page Title="" Language="C#" MasterPageFile="~/CUDAMasterPage.Master" AutoEventWireup="true" CodeBehind="CUDAExportContract.aspx.cs" Inherits="JKTS_Contract_system.CUDAExportContract" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lbl_dept" runat="server" Text="Label" Visible="false"></asp:Label>
    <asp:GridView ID="contractGridView" runat="server" Height="450px" Width="950px" AutoGenerateColumns="False" CssClass="auto-style1" DataKeyNames="contractID">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="contractAmount" HeaderText="Transactional Amoung" DataFormatString="${0:#,0}" />
