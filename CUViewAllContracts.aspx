<%@ Page Title="" Language="C#" MasterPageFile="~/CUMasterPage.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="CUViewAllContracts.aspx.cs" Inherits="JKTS_Contract_system.CUViewAllContracts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td class="auto-style11">
                <asp:DropDownList ID="ddlcontractDepartment" EnableViewState="false" AppendDataBoundItems="true" runat="server" AutoPostBack="True" Width="120px" Font-Size="11px" DataSourceID="SqlDataSource3" DataTextField="User_Dept" DataValueField="User_Dept" OnSelectedIndexChanged="ddlcontractDepartment_SelectedIndexChanged">
                    <asp:ListItem Value="" Text="" Enabled="false" />
                    <asp:ListItem Text="All" Value="%" />
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Project %>" SelectCommand="SELECT DISTINCT [User_Dept] FROM [Dept]"></asp:SqlDataSource>
            </td>
    ...
    <asp:GridView ID="contractGridView" runat="server" CssClass="GridView" RowStyle-Height="70px" AutoGenerateColumns="False" DataKeyNames="contractID" OnSelectedIndexChanged="contractGridView_SelectedIndexChanged" OnRowDeleting="contractGridView_RowDeleting" OnRowCommand="contractGridView_RowCommand" OnRowDataBound="contractGridView_RowDataBound">
            ...
            <td>
                <asp:GridView ID="EmailDeptHead" runat="server" Height="47px" Width="169px" AutoGenerateColumns="False" DataKeyNames="User_Name" OnRowDataBound="EmailDeptHead_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="contractStartDate" HeaderText="Starting Date (yyyy/mm/dd)" DataFormatString="{0:yyyy/MM/dd}" />
                        <asp:BoundField DataField="contractEndDate" HeaderText="Ending Date (yyyy/mm/dd)" DataFormatString="{0:dd/MM/yyyy}" />
