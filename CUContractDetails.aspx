<%@ Page Title="" Language="C#" MasterPageFile="~/CUMasterPage.Master" AutoEventWireup="true" CodeBehind="CUContractDetails.aspx.cs" Inherits="JKTS_Contract_system.CUContractDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p>
        <asp:Button ID="contractListingBtn" runat="server" OnClick="contractListingBtn_Click" Text="Contract Listings" />
    </p>
