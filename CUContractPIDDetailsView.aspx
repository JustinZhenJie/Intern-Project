<%@ Page Title="" Language="C#" MasterPageFile="~/CUMasterPage.Master" AutoEventWireup="true" CodeBehind="CUContractPIDDetailsView.aspx.cs" Inherits="JKTS_Contract_system.CUContractPIDDetailsView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="contractID" OnDataBound="DetailsView1_DataBound">
        <Fields>
    ...
    <asp:Button ID="backBtn" runat="server" Text="Contract Listings" OnClick="backBtn_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p></p>
    ...
    <asp:GridView ID="contractGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="contractID" OnSelectedIndexChanged="contractGridView_SelectedIndexChanged" OnRowDataBound="contractGridView_RowDataBound">
